                    ...
                    dom: [
                        {
                            ...
                            fill: ["rgba(0,0,0,0)","page1-asset2.png",'0px','0px']
                        },
                       /* {
                            id: 'page1-asset1',
                            type: 'image',
            ...
            "menu": {
                ...
                content: {
                    dom: [
                       ...
                       /* {
                            rect: ['40px', '40px', '130px', '33px', 'auto', 'auto'],
                            id: 'active1',
						...
						,*/
                        {
                            rect: ['180px', '40px', '130px', '33px', 'auto', 'auto'],
                            id: 'inactive1',
...
AdobeEdge.registerCompositionDefn(compId, symbols, fonts, scripts, resources, opts);
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("stroke-cs-1_edgeActions.js");
})("EDGE-3046095798");
